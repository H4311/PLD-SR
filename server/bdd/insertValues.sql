...
INSERT INTO pieces(nom) VALUES ('room 1');
INSERT INTO pieces(nom) VALUES ('Salle d\'attente');

INSERT INTO murs(idPiece, x1, y1, x2, y2, ordre, isPorte)
VALUES ((SELECT id FROM pieces WHERE nom = 'Salle d\'attente'), 1, 1, 2, 2, 3, true);

INSERT INTO murs(idPiece, x1, y1, x2, y2, ordre, isPorte)
VALUES ((SELECT id FROM pieces WHERE nom = 'room 1'), 1, 2, 3, 4, 42, true);
